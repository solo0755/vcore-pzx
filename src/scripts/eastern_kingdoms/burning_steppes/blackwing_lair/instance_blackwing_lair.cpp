            ...
            case NPC_RAZORGORE:
                if (m_auiEncounter[TYPE_RAZORGORE] == FAIL)
                {
					if (Creature* pRazorgore = instance->GetCreature(m_auiData[DATA_RAZORGORE_GUID])) {
						//[如果我要落入地狱,那么你们这些凡人也要跟我同去!]
						char msg[] = { -27,-90,-126,-26,-98,-100,-26,-120,-111,-24,-90,-127,-24,-112,-67,-27,-123,-91,-27,-100,-80,-25,-117,-79,44,-23,-126,-93,-28,-71,-120,-28,-67,-96,-28,-69,-84,-24,-65,-103,-28,-70,-101,-27,-121,-95,-28,-70,-70,-28,-71,-97,-24,-90,-127,-24,-73,-97,-26,-120,-111,-27,-112,-116,-27,-114,-69,33,0 };
						pRazorgore->PlayDirectSound(8278);
						pRazorgore->MonsterYell(msg);
					}
                }
                break;
        }
    ...
    bool OnUse(Unit* pUser) override
    {
        ...
        if (ScriptedInstance* pInstance = (ScriptedInstance*)me->GetInstanceData())
        {
            ...
            if (pUser->IsCreature() && pUser->GetEntry() == NPC_RAZORGORE)
            {
				...
				//[不!住手!我要你的头颅来弥补你的罪行!]
				char msg1[] = { -28,-72,-115,33,-28,-67,-113,-26,-119,-117,33,-26,-120,-111,-24,-90,-127,-28,-67,-96,-25,-102,-124,-27,-92,-76,-23,-94,-123,-26,-99,-91,-27,-68,-91,-24,-95,-91,-28,-67,-96,-25,-102,-124,-25,-67,-86,-24,-95,-116,33,0 };

				//[蠢货!这些蛋比你认为的要珍贵的多!]
				char msg2[] = { -24,-96,-94,-24,-76,-89,33,-24,-65,-103,-28,-70,-101,-24,-101,-117,-26,-81,-108,-28,-67,-96,-24,-82,-92,-28,-72,-70,-25,-102,-124,-24,-90,-127,-25,-113,-115,-24,-76,-75,-25,-102,-124,-27,-92,-102,33,0 };

				//[你要为强迫我这么做而付出代价!]
				char msg3[] = { -28,-67,-96,-24,-90,-127,-28,-72,-70,-27,-68,-70,-24,-65,-85,-26,-120,-111,-24,-65,-103,-28,-71,-120,-27,-127,-102,-24,-128,-116,-28,-69,-104,-27,-121,-70,-28,-69,-93,-28,-69,-73,33,0 };
				switch (urand(0, 5))
                {
                    case 0:
                        pUser->MonsterYell(msg1);
                        pUser->PlayDirectSound(8277);
                        break;
                    case 1:
                        pUser->MonsterYell(msg2);
                        pUser->PlayDirectSound(8276);
                        break;
                    case 2:
                        pUser->MonsterYell(msg3);
...
bool AreaTrigger_at_orb_of_command(Player* pPlayer, AreaTriggerEntry const* pAt)
{
    ...
    {
        Corpse *pCorpse = pPlayer->GetCorpse();//pPlayer->GetQuestRewardStatus(7761) 去掉了黑E的任务限制
        if (pPlayer->IsDead() && pCorpse && (pCorpse->GetMapId() == 469))
        {
