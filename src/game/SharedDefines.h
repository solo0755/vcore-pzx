...
enum UnitDynFlags // 控制生物动作外观标识
{
    UNIT_DYNFLAG_NONE                       = 0x0000,
    UNIT_DYNFLAG_LOOTABLE                   = 0x0001,
    UNIT_DYNFLAG_TRACK_UNIT                 = 0x0002,//移动
    UNIT_DYNFLAG_TAPPED                     = 0x0004,       // Lua_UnitIsTapped 发掘
    UNIT_DYNFLAG_TAPPED_BY_PLAYER           = 0x0008, // Et non *_ROOTED !  发掘by玩家？
    UNIT_DYNFLAG_SPECIALINFO                = 0x0010, //特殊 
    UNIT_DYNFLAG_DEAD                       = 0x0020, //死亡
};
