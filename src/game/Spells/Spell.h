...
class Spell
{
    ...
    public:
        ...
        // For summoning ritual helpers visual spell  召唤仪式中协助者 只有一个视觉spell？
        void SetChannelingVisual(bool value) { m_isChannelingVisual = value; }
        bool IsChannelingVisual() const { return m_isChannelingVisual; }//判断是否是协助召唤者的点击技能
    ...
    protected:
        ...
        struct TargetInfo
        {
            ...
            uint8  effectMask:8;//设置掩码为8=0b1000; 二进制掩码
            bool   processed:1;
            bool   deleted:1;
        };
