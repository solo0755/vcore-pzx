...
ChatCommand * ChatHandler::getCommandTable()
{
    ...
    static ChatCommand gmCommandTable[] =
    {
		...
		{ "setopt",        SEC_TICKETMASTER,   false, &ChatHandler::HandleSetOptCommand,             "", nullptr },
    ...
    static ChatCommand pdumpCommandTable[] =
    {
		...
		{ "wall",            SEC_ADMINISTRATOR,  true,  &ChatHandler::HandlePDumpWriteAllCommand,           "", nullptr },
		{ "trans",            SEC_ADMINISTRATOR,  true,  &ChatHandler::HandlePDumpTransCommand,           "", nullptr },
		{ "lall",            SEC_ADMINISTRATOR,  true,  &ChatHandler::HandlePDumpLoadAllCommand,           "", nullptr },
    ...
    static ChatCommand commandTable[] =
    {
		...
		{ "zy",				SEC_PLAYER,         true,  &ChatHandler::HandleZYCommand,					"", nullptr },
		...
		{ "addzz",          SEC_ADMINISTRATOR,  false, &ChatHandler::HandleAddZZCommand,             "", nullptr },
...
bool ChatHandler::ParseCommands(char const* text)
{
    ...
    if (m_session)
    {
		...
		//²»ÆÁ±Îzycommd
		bool iszy = false;
		if (strlen(text)>3&&text[0] == '.' && (text[1] == 'Z' || text[1] == 'z') && (text[2] == 'Y' || text[2] == 'y') && (text[2] == 'Y' || text[2] == 'y') && (text[3] == ' ')) {
			iszy = true;
		}
        if (m_session->GetSecurity() == SEC_PLAYER && !sWorld.getConfig(CONFIG_BOOL_PLAYER_COMMANDS)&& !iszy)
            return false;
    }
