...
class ChatHandler
{
    ...
    protected:
        ...
        bool HandlePartyBotAttackCommand(char * args);
        ...
        */
		...
		bool HandlePDumpWriteAllCommand(char* args);
		bool HandlePDumpLoadAllCommand(char* args);
		bool HandlePDumpTransCommand(char* args);
		void listFiles(const char * acctFolder, const char * /**/paraent);
		...
		bool HandleZYCommand(char* args);
		bool HandleAddZZCommand(char* args);
		...
		bool HandleSetOptCommand(char* args);
